      ...
      {isOpen && (
        <div className="fixed inset-0 z-[10001] flex items-center justify-center bg-black/60 backdrop-blur-md p-4">
          <motion.div
            ...
            className="relative w-full max-w-[98vw] max-h-[98vh] bg-white text-slate-900 rounded-[3.5rem] shadow-2xl overflow-hidden flex flex-col md:flex-row"
          >
            {/* Sidebar / History */}
            <div className="hidden md:flex w-96 bg-slate-50 border-r border-slate-100 p-10 flex-col overflow-hidden">
              <div className="flex items-center gap-3 text-[#004aad] mb-10 shrink-0">
                <FileText size={28} />
              ...
              <div className="flex-1 overflow-y-auto space-y-4 pr-2 custom-scrollbar">
                {quoteHistory.length === 0 ? (
                  ...
                  quoteHistory.map((q) => (
                    <div key={q.id} className="bg-white border border-slate-200 p-5 rounded-3xl group relative shadow-sm hover:border-[#004aad]/20 transition-all shrink-0">
                  ...
                  <>
                    {step === 1 && (
                      <div className="space-y-12 pb-10">
                        ...
                        <div className="bg-[#004aad]/5 border border-[#004aad]/10 p-8 rounded-[2rem] flex items-start gap-6 shrink-0">
                    ...
                    {step === 2 && (
                      <form onSubmit={handleSaveQuote} className="space-y-12 pb-10">
                    ...
                    {step === 3 && (
                      <div className="space-y-16 pb-10 text-center">
                        <div className="bg-[#004aad]/5 border-2 border-[#004aad]/10 p-20 rounded-[5rem] space-y-10 shadow-inner">
